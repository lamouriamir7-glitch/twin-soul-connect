...
/** برومبت تفصيلي يلصقه المستخدم في أي ذكاء اصطناعي اعتاد الدردشة معه */
export const AI_PROMPT = `أريد منك أن تحلّل شخصيتي بناءً على كامل محادثاتنا السابقة وكل ما تعرفه عني.
